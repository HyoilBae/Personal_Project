    ...
    class Program
    {
        ...
        static void RiceInfo(RiceCookerInfo Info)
        {
            ...
            if (Info.CoverOpenClose)
                Console.Write("Lid : Open");
            else
                Console.Write("Lid : Close");
        ...
        {           
            ...
            string[] MenuItem = { "   Power   ", "   Lid   ", "   Cooking   ", "   Warming   ", "   Cancel   ",
                                    "  HeadCount  ", "    Rice   ", "    Water    "  };
